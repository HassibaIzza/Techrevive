                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="text-center">
                                    ...
                                    <p>Vous avez déjà un compte ? <a href="{{ url('/login') }}">Connectez-vous ici</a>
                                    </p>
                                </div>
                                <div class="d-grid">
                          ...
                          <span>Inscrivez-vous avec Google</span>
                                ...
                                <div class="login-separater text-center mb-4"> <span>OU INSCRIVEZ-VOUS AVEC E-MAIL</span>
                                    <hr/>
                                </div>
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{route('register')}}">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input name="name" type="text" class="form-control" id="inputName"
                                                   placeholder="Votre nom" autocomplete="name" value="{{old('name')}}"
                                                   autofocus
                                                   required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input name="email" type="email" class="form-control"
                                                   ...
                                                   placeholder="exemple@utilisateur.com" value="{{old('email')}}">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input name="username" type="text" class="form-control" id="inputUserName"
                                                   placeholder="Choisissez un nom d'utilisateur unique" autocomplete="username"
                                                   autofocus
                                        ...
                                        <div class="col-12">
                                            <label for="inputChoosePassword" class="form-label">Confirmez le mot de passe
                                            </label>
                                            ...
                                            <div class="col-sm-12">
                                                <label for="inputRole" class="form-label">Rôle utilisateur</label>
